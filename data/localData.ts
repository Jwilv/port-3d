...
export const Proyects: Proyetc[] = [
    {
        ...
        links: [
            ...
            {
                label: 'Linkedin',
                url: 'https://www.linkedin.com/posts/juan-wilvers-450a11233_desarrollodesoftware-nextjs-typescript-activity-7157423038051893250-6-uB?utm_source=share&utm_medium=member_desktop'
            }
        ]
    },
    {
        ...
        links: [
            {
                label: 'Github',
                url: 'https://github.com/Jwilv/SpendWise'
            },
            {
                label: 'Linkedin',
    ...
    },
    {
        ...
        links: [
            {
                label: 'Github',
                url: 'https://github.com/Jwilv/coCalend'
            }
        ]
    },
    {
        ...
        links: [
            {
                label: 'Github',
                url: 'https://github.com/Jwilv/LiveSpot'
            }
        ]
    },
    {
        title: 'AI Creators',
        image: imgsIa,
        desc: 'AI Creators es tu herramienta para la expresión artística personalizada. Utilizando inteligencia artificial, transformamos tus especificaciones en iamágenes únicas y cautivadoras.',
        subDesc: 'Después, compártelas en nuestra comunidad de artistas, donde podrás inspirarte, obtener retroalimentación y explorar el talento de otros usuarios. Únete a AI Creators y da vida a tus ideas creativas como nunca antes.',
        links: [
            {
                label: 'Github',
                url: 'https://github.com/Jwilv/AI-Creators'
            }
        ]
    },
    {
        ...
        links: [
            {
                label: 'Github',
                url: 'https://github.com/Jwilv/GlobalChat'
            }
        ]
    },
